...
public class AliyunPlayerComponet extends FrameLayout implements ComponentHolder {
    /**
     * 播放View
     */
    ...
    public AliyunPlayerComponet(@NonNull Context context) {
        this(context, null, 0);
    }

    public AliyunPlayerComponet(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AliyunPlayerComponet(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
