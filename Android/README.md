...
## 介绍
AUI Kits 互动直播场景（[横屏样式](https://help.aliyun.com/zh/apsara-video-sdk/use-cases/landscape-mode-for-android)）集成工具是阿里云针对企业提供的跨平台直播服务，为业务方提供培训、会议、活动等场景的能力，借助视频直播稳定、流畅、灵活的产品能力，以低代码的方式助力业务方快速发布直播应用。
